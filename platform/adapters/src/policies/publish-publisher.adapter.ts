...
export class PublishPublisherAdapter implements PublishPublisher {
  ...
  async publishFairnessPolicy(input: Parameters<PublishPublisher['publishFairnessPolicy']>[0]): Promise<Awaited<ReturnType<PublishPublisher['publishFairnessPolicy']>>> {
