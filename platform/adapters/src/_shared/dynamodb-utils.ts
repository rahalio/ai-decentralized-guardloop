 ...
 *
 * @returns The core table name (e.g., "guardloop-core-dev")
 ...
 *
 * @returns The base table name (e.g., "guardloop-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "guardloop-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "guardloop-app-realtime-dev")
