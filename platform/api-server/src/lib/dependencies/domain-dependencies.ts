...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/controls\//, domain: "controls" },
  ...
  { pattern: /\/remediations\//, domain: "remediations" },
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      ...
      case "policies":
        ...
        break;
      case "remediations":
        domainDeps = buildRemediationsDomainModule(dynamoClient);
        break;
      case "reporting":
...
export interface DomainDependencies {
  ...
  remediations: RemediationsDomainModule;
...
export function getRemediationsDeps(
  request: FastifyRequest,
): DomainDependencies["remediations"] {
  return getDomainDeps(request, "remediations");
}
